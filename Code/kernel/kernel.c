...
void kernel_init(void *memory, size_t memorySize)
{
    u64 *pt = (u64 *)memory;
...
void kernel_start(unsigned int *framebuffer, int width, int height, void *pageBuffer, int pageBufferSize)
{
	...
	kernel_init(pageBuffer, pageBufferSize);
